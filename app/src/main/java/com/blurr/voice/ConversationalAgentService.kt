...
//    }
    ...
    private fun initializeConversation() {
        val memoryContextSection = if (MEMORY_ENABLED) {
            ...
            """
            ### Memory Status ###
            Memory system is temporarily disabled. AJ cannot remember or learn from previous conversations at this time.
        ...
        val systemPrompt = """
            You are a helpful voice assistant called AJ that can either have a conversation or ask an executor to execute tasks on the user's phone.
