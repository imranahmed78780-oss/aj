...
class MainActivity : BaseNavigationActivity() {
    ...
    private fun handleIntent(intent: Intent?) {
        if (intent?.action == "com.blurr.voice.WAKE_UP_PANDA") {
            Logger.d("MainActivity", "Wake up AJ shortcut activated!")
    ...
    private fun startConversationalAgent() {
        if (!ConversationalAgentService.isRunning) {
            ...
            Toast.makeText(this, "AJ is waking up...", Toast.LENGTH_SHORT).show()
        } else {
            Logger.d("MainActivity", "ConversationalAgentService is already running.")
            Toast.makeText(this, "AJ is already awake!", Toast.LENGTH_SHORT).show()
        }
    }
    ...
    private fun initializePandaStateManager() {
        ...
        stateChangeListener = { newState ->
            ...
            Logger.d("MainActivity", "AJ state changed to: ${newState.name}")
        }
    ...
    private fun showDisclaimerDialog() {
        val dialog = AlertDialog.Builder(this)
            .setTitle("Disclaimer")
            .setMessage("AJ is an experimental AI assistant and is still in development. It may not always be accurate or perform as expected. It does small task better. Your understanding is appreciated!")
